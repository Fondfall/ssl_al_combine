...
# data = np.loadtxt(open("w2v_big_mean.csv", "rb"), delimiter=",", skiprows=0)
...
for i in range(max_iterations):
    ...
    lp_model = LabelSpreading(gamma=0.16, max_iter=30)  # 768  big_mean 0.43&0.81  0.693&0.79
    ...
    # print(unlabeled_indices,len(unlabeled_indices))
    unlabeled_indices = np.delete(unlabeled_indices, delete_indices)
    np.random.RandomState(99).shuffle(unlabeled_indices)
